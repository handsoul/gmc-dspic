...
{\
    u8 __i = 0;\
     _W(PBUF,0) = ((SID&0x7FF)<<2)|((SRR&1)<<1)|(IDE&0x01);\
     _W(PBUF,1) = (EID_6_17&0xFFF);\
     _W(PBUF,2) = ((EID_05&0x3F)<<10)|((RTR&0x01)<<9)|((RB1&0x01)<<8)|((RB0&0x01)<<4)|(DLC&0x0F);\
...
extern bool SendCanMsg(CAN_MSG_ST * pstMsg,u8 ucMsgBufNo);
#endif // __BSP_CAN_H__
// end of file
